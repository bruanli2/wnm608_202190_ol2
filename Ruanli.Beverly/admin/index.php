...
function showProductPage($o) {
    ...
    $thumbnail = array_reduce(explode(",", $o->thumbnail),function($r,$o){return $r."<img src='img/$o'>";});
    ...
    <form method="post" action= "{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
        ...
        <div class="form-control">
            ...
            <input class="form-input" name="product-price" id="product-price" type="Number" min="0" max="1000" step="0.1" value="$o->price" placeholder="Enter Product Price" > 
        </div>
        <div class="form-control">
        ...
        <div class="form-control">
            ...
            <textarea class="form-input" name="product-description" id="product-description"  value="" placeholder="Enter Product Description" >$o->description</textarea>
        </div>
        <div class="form-control">
